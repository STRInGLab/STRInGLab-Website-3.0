<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['id']) && $_POST['action'] == 'delete') {  
		...
		if (in_array($table, ['vendorDetails'])) {  
				...
				echo "<tr>  
						...
						<td class='text-end'>  
							<button class='btn btn-bg-light btn-color-muted btn-active-color-primary btn-sm px-4 me-1 delete-btn'   
								data-id='{$row['ID']}'   
								data-type='vendorDetails'>Delete</button>  
...
<html lang="en">
	...
	<head>
<base href="./" />
		<title>S.T.R.In.G - Vendor Details Dashboard</title>
		<meta charset="utf-8" />
	...
	<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Vendor Details Dashboard</h1>
									</div>
									<!--end::Page title-->
									<!--begin::Actions-->
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										<!--begin::Primary button-->
										<a href="#" class="btn btn-sm fw-bold btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_new_target">Add Vendor</a>
										<!--end::Primary button-->
									</div>
									<!--end::Actions-->
								</div>
										...
										<div class="d-flex flex-wrap flex-sm-nowrap">
											...
											<div class="me-7 mb-4">
												<div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
													<img src="assets/media/avatars/vendorsDashboard.jpg" alt="image" />
			...
			<div class="modal-dialog modal-dialog-centered mw-650px">
				...
				<div class="modal-content rounded">
					...
					<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
						<!--begin:Form-->
						<form id="vendor_details_form" class="form" method="post" enctype="multipart/form-data">
                            <div class="mb-13 text-center">
                                <h1 class="mb-3">Vendor On-Boarding</h1>
                            ...
                            <div class="d-flex flex-column mb-8 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="Enter Vendor Name" name="target_title" required />
                            </div>
                            ...
                            <div class="text-center">
                                <button type="button" id="vendor_details_form_submit" class="btn btn-primary">
		...
		$(document).ready(function() {    
			$('#vendor_details_form_submit').click(function() {    
				var formData = new FormData($('#vendor_details_form')[0]);    
				...
				formData.append('form_type', 'vendorDetails');    
		
				$.ajax({    
					url: 'clientsubmit.php',    
					type: 'POST',    
					data: formData,    
					processData: false,    
					contentType: false,  
					...
					success: function(response) {    
						if (response.error) {    
							...
							// Optionally, you can introduce a slight delay before reloading  
							setTimeout(function() {  
								location.reload();  
							}, 500);  
						}    
		...
		<script>  
			$(document).ready(function() {  
				...
				$('.edit-btn').click(function() {  
					...
					$('#vendor_id').val(id); // Set the vendor ID  
			
					// Change modal title for editing  
					$('#modal_title').text('Edit Vendor Details');  
			
					// Open the modal  
					$('#kt_modal_new_target').modal('show');  
				});  
			
				// When 'Add Vendor' is clicked, reset the form  
				$('a[data-bs-target="#kt_modal_new_target"]').click(function() {  
					$('#vendor_details_form')[0].reset();  
					$('#vendor_id').val(''); // Clear the vendor ID  
					$('#modal_title').text('Vendor On-Boarding'); // Reset the modal title  
				});  
			});  
		</script>  
		<!--end::Javascript-->
