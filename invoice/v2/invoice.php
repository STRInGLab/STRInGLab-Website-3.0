        ...
        <div class="tm_invoice_in">
          <div class="tm_invoice_head tm_align_center tm_accent_bg">
            <div class="tm_invoice_left">
              <div class="tm_logo"><img src="https://stringspace.blob.core.windows.net/stringspace/string-fullform-logo.png" alt="Logo" width="350"></div>
            </div>
          ...
          <div class="tm_invoice_info">
            <div class="tm_invoice_info_left tm_gray_bg">
              ...
              <p class="tm_mb0">
              <?php 
                echo $invoice['name'] . '<br>';

                $invoiceTo = $invoice['invoiceTo'];
                $modifiedSentence = '';
                $lineLength = 0;
                
                $words = explode(' ', $invoiceTo);
                foreach ($words as $word) {
                    if ($lineLength + strlen($word) + 1 > 40) {
                        $modifiedSentence .= '<br>';
                        $lineLength = 0;
                    }
                    $modifiedSentence .= $word . ' ';
                    $lineLength += strlen($word) + 1; // Adding 1 for the space
                }
                
                echo rtrim($modifiedSentence) . '<br>';

                echo 'GSTIN: ' . $invoice['gst_number'];
            ?>
              </p>
            </div>
