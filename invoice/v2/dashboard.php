...
<base href="./" />
		...
		<script>
        var totalInvoices = <?php echo $totalInvoices; ?>;
        var paidInvoices = <?php echo $paidInvoices; ?>;

        var ctx = document.getElementById('kt_chartjs_3');

        // Define colors
        var primaryColor = '#00aaff';
        var successColor = '#28a745';

        // Chart data
        const data = {
            labels: ['Total Invoices', 'Paid Invoices'],
            datasets: [{
                data: [totalInvoices, paidInvoices],
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Invoice Module Dashboard</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
											...
											<div class="card card-flush h-md-50 mb-5 mb-xl-10">
												...
												<div class="card-body pt-2 pb-4 d-flex align-items-center">
													...
													<div class="d-flex flex-center me-5 pt-2">
														<div id="kt_chartjs_3" style="min-width: 70px; min-height: 70px" data-kt-size="70" data-kt-line="11"></div>
													</div>
													<!--end::Chart-->
													<!--begin::Labels-->
