...
if (!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] !== true) {
        ...
        if ($result) {
            foreach ($result as $row) {
                echo "<tr data-invoice-no='{$row['invoiceNo']}'>
                        ...
                        <td>{$row['taxType']}</td>
                        <td class='text-end'>
							<button class='btn btn-bg-light btn-color-muted btn-active-color-primary btn-sm px-4 me-1' data-id='{$row['id']}' data-type='{$type}'>Delete</button>
							<a href='edit_page.php?id={$row['id']}' class='btn btn-bg-light btn-color-muted btn-active-color-primary btn-sm px-4'>Edit</a>
						</td>
					</td>
                     </tr>";
            }
	...
	function getTotalInvoices($pdo) {
		$sql = "SELECT COUNT(*) as total FROM Invoice WHERE invoiceOrQuote = 'Invoice'";
		$stmt = $pdo->prepare($sql);
		$stmt->execute();
	...
	function getPaidInvoices($pdo) {
		$sql = "SELECT COUNT(*) as total FROM Invoice WHERE invoiceOrQuote = 'Invoice' AND paid_flag = '1'";
		$stmt = $pdo->prepare($sql);
		$stmt->execute();
		$result = $stmt->fetch(PDO::FETCH_ASSOC);
		return $result['total'];
...
<html lang="en">
	...
	<head>
<base href="./" />
		<title>S.T.R.In.G - Dashboard</title>
		<meta charset="utf-8" />
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Receipts Dashboard</h1>
									</div>
									<!--end::Page title-->
									<!--begin::Actions-->
									<!--end::Actions-->
									...
									<div class="card-body pt-9 pb-0">
										...
										<div class="d-flex flex-wrap flex-sm-nowrap">
											...
											<div class="me-7 mb-4">
												<div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
													<img src="assets/media/avatars/invoice.jpeg" alt="image" />
												...
												<div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
													...
													<div class="d-flex flex-column">
														...
														<div class="d-flex align-items-center mb-2">
															<a class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">Receipts</a>
														</div>
													</div>
													<!--end::User-->
													<!--begin::Actions-->
										...
										<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
											...
											<li class="nav-item mt-2">
												<a class="nav-link text-active-primary ms-0 me-10 py-5" href="invoices.php">Invoices</a>
											</li>
											<!--end::Nav item-->
											<!--begin::Nav item-->
											<li class="nav-item mt-2">
											...
											<!--begin::Nav item-->
											<li class="nav-item mt-2">
												<a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="receipts.php">Receipts</a>
											</li>
										</ul>
										<!--begin::Navs-->
									</div>
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_sales_table">
												<thead>
													<tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
														<th class="min-w-125px dt-orderable-asc dt-orderable-desc">ID</th>
														<th class="min-w-125px dt-orderable-asc dt-orderable-desc">Invoice To</th>
														<th class="min-w-125px dt-orderable-asc dt-orderable-desc">Name</th>
														<th class="min-w-125px dt-orderable-asc dt-orderable-desc">Number</th>
														<th class="min-w-125px dt-orderable-asc dt-orderable-desc">Date</th>
														<th class="min-w-125px dt-orderable-asc dt-orderable-desc">Advanced Paid</th>
														<th class="min-w-125px dt-orderable-asc dt-orderable-desc">Tax Type</th>
									...
									<div class="overflow-auto pe-3">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Alan Nilson">
												<img src="assets/media/avatars/Invoice.webp" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
