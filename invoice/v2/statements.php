												...
												<div class="table-responsive">
													...
													<table class="table align-middle table-row-bordered table-row-solid gy-4 gs-9">
														...
														<thead class="border-gray-200 fs-5 fw-semibold bg-lighten">
															<tr>
																<th class="min-w-150px px-0">ID</th>
																<th class="min-w-350px">Invoice To</th>
																<th class="min-w-150px px-0">Name</th>
																<th class="min-w-150px px-0">Number</th>
																<th class="min-w-175px ps-9">Date</th>
																<th class="min-w-125px">Advance Paid</th>
																<th class="min-w-150px px-0">Tax Type</th>
