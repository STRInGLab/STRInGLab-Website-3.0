...
if (!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] !== true) {
    ...
    // Correct: Deleting from the clientDetails table  
...
<html lang="en">
	...
	<head>
<base href="./" />
		<title>S.T.R.In.G - Client Details Dashboard</title>
		<meta charset="utf-8" />
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Client Details Dashboard</h1>
									</div>
									<!--end::Page title-->
									<!--begin::Actions-->
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										<!--begin::Primary button-->
										<a href="#" class="btn btn-sm fw-bold btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_new_target">Add Client</a>
										<!--end::Primary button-->
									</div>
									<!--end::Actions-->
								</div>
										...
										<div class="d-flex flex-wrap flex-sm-nowrap">
											...
											<div class="me-7 mb-4">
												<div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
													<img src="assets/media/avatars/clientsDashboard.jpg" alt="image" />
												...
												<div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
													...
													<div class="d-flex flex-column">
														...
														<div class="d-flex align-items-center mb-2">
															<a class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">Clients</a>
														</div>
													</div>
													<!--end::User-->
													<!--begin::Actions-->
					...
					<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
						...
						<form id="client_details_form" class="form" method="post" enctype="multipart/form-data">
                            <div class="mb-13 text-center">
                                <h1 class="mb-3">Client On-Boarding</h1>
                            ...
                            <div class="d-flex flex-column mb-8 fv-row">
                                <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                    <span class="required">Company/Client Name</span>
                                </label>
                                <input type="text" class="form-control form-control-solid" placeholder="Enter Company/Client Name" name="target_title" required />
                            </div>
				...
				$('.delete-btn').click(function() {  
					...
					if (confirm('Are you sure you want to delete this record?')) {  
						$.ajax({  
							...
							type: 'POST',  
							data: {id: id},  // Only 'id' is sent, since we only need 'id' to delete  
							success: function(response) {  
		...
		<script>  
			$(document).ready(function() {  
				...
				$('.edit-btn').click(function() {  
					...
					$('#client_id').val(id); // Set the client ID  
				...
				// When 'Add Client' is clicked, reset the form  
				$('a[data-bs-target="#kt_modal_new_target"]').click(function() {  
					$('#client_details_form')[0].reset();  
					$('#client_id').val(''); // Clear the client ID  
					$('#modal_title').text('Client On-Boarding'); // Reset the modal title  
				});  
				...
				$('#client_details_form_submit').click(function() {  
					...
					// Determine if it's an edit or add based on the presence of client ID  
