        ...
        <div class="tm_invoice_in">
          <div class="tm_invoice_head tm_align_center tm_accent_bg">
            <div class="tm_invoice_left">
              <div class="tm_logo"><img src="https://stringlab-spaces.blr1.cdn.digitaloceanspaces.com/string-fullform-logo.png" alt="Logo" width="350"></div>
            </div>
          ...
          <div class="tm_invoice_info">
            ...
            <div class="tm_invoice_info_right tm_text_right">
              ...
              <p class="tm_invoice_date tm_m0">Date: <b class="tm_primary_color"><?php echo $invoice['date']; ?></p></b></p>
            </div>
          </div>
